...
const motion = function (isStage, targetId) {
    return `
    <category name="Motion (Beginner)" colour="#4C97FF" secondaryColour="#3373CC">
        ${isStage ? `
...
const looks = function (isStage, targetId) {
    return `
    <category name="Looks (Beginner)" colour="#9966FF" secondaryColour="#774DCB">
        ${isStage ? '' : `
...
const sound = function () {
    return `
    <category name="Sound (Beginner)" colour="#D65CD6" secondaryColour="#BD42BD">
...
const events = function () {
    return `
    <category name="Events (Intermediate)" colour="#FFD500" secondaryColour="#CC9900">
...
const control = function (isStage) {
    return `
    <category name="Control (Advanced)" colour="#FFAB19" secondaryColour="#CF8B17">
...
const sensing = function (isStage) {
    return `
    <category name="Sensing (Advanced)" colour="#4CBFE6" secondaryColour="#2E8EB8">
        ${isStage ? '' : `
...
const operators = function () {
    return `
    <category name="Operators (Advanced)" colour="#40BF4A" secondaryColour="#389438">
...
const variables = function () {
    return `
    <category name="Variables (Advanced)" colour="#FF8C1A" secondaryColour="#DB6E00" custom="VARIABLE">
    </category>
    `;
};
...
const myBlocks = function () {
    return `
    <category name="My Blocks (Advanced)" colour="#FF6680" secondaryColour="#FF4D6A" custom="PROCEDURE">
    </category>
    `;
};
